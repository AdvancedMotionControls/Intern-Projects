 ...
 * 
 * This program is designed to scan a file or a directory for .adf files and check 
 * those files for any duplicated initialized drive variables. To specify a file or 
 * directory to check, add the complete path to the command line.
 *
 * */
